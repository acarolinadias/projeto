<template>
    <div>
        <div v-if="modoJogo==null">
            <h2>Escolher modo de Jogo</h2>
            <a v-on:click.prevent="createVSbot()" class="btn btn-success">Contra BOTS</a>
            <a v-on:click.prevent="createVSele()" class="btn btn-success">Contra Ninguém</a>
        </div>
